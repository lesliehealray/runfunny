...
DATABASES['default']['NAME'] = 'runfunny_%s' % ENVIRONMENT.lower()
DATABASES['default']['USER'] = 'runfunny_%s' % ENVIRONMENT.lower()
DATABASES['default']['HOST'] = os.environ.get('DB_HOST', '')
DATABASES['default']['PORT'] = os.environ.get('DB_PORT', '')
DATABASES['default']['PASSWORD'] = os.environ.get('DB_PASSWORD', '')

WEBSERVER_ROOT = '/var/www/runfunny/'
...
LOGGING['handlers']['file']['filename'] = os.path.join(
    WEBSERVER_ROOT, 'log', 'runfunny.log')
...
EMAIL_SUBJECT_PREFIX = '[Runfunny %s] ' % ENVIRONMENT.title()
...
# BROKER_URL = 'amqp://runfunny_%(ENVIRONMENT)s:%(BROKER_PASSWORD)s@%(BROKER_HOST)s/runfunny_%(ENVIRONMENT)s' % os.environ  # noqa
